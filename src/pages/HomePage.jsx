    ...
    <div>
        ...
        <div className="about-split">
          <div className="about-img-wrap">
            <img
              ...
              alt="Him Setu Infrastructure"
            />
          </div>
          <div className="about-text">
            <div className="sec-label">Who We Are</div>
            <h2 className="sec-title" style={{ marginBottom: 24 }}>
              Civil engineering built on 15 years of government trust
            </h2>
            <p>
              Him Setu Infrastructure Private Limited is a government-authorized
              civil engineering contractor specializing in the construction,
              development, and maintenance of roads, buildings, bridges, and
              infrastructure works across Himachal Pradesh.
            </p>
            <p>
              Founded by Directors Ankush Parmar and Rohit Kapil — each with 15+
              years of active infrastructure experience — we bring hands-on,
              director-led project execution to every contract we undertake.
            </p>
            <p>
              We are an authorized service provider to the PWD and NHAI
              Department, ensuring full compliance with public sector
              infrastructure standards and government procurement guidelines.
            </p>
            <div
              style={{
                marginTop: 28,
      ...
      <section className="section">
        ...
        <h2 className="sec-title">
          Government and infrastructure projects across HP
        </h2>
      ...
      <section className="section teal">
        ...
        >
          {[
            [
              "PWD Authorized",
              "Approved contractor for Public Works Department projects across Himachal Pradesh.",
            ],
            [
              "NHAI Authorized",
              "Certified service provider for Irrigation and Public Health Department contracts.",
            ],
            [
              "Incorporated 2026",
              "Recently registered Private Limited entity with full statutory compliance and active credentials.",
            ],
          ].map(([title, desc]) => (
            <div key={title}>
              <h3
        ...
        <div className="contact-split">
          <div>
            ...
            <div className="contact-info-block">
              {[
                [
                  "Director — Ankush Parmar",
                  `${COMPANY.phone}\n${COMPANY.email}`,
                ],
                [
                  "Director — Rohit Kapil",
                  `${COMPANY.phone2}\n${COMPANY.email}`,
                ],
